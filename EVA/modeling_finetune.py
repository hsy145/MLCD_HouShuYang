...
try:
    ...
    FusedLayerNorm = nn.LayerNorm  # 使用PyTorch标准LayerNorm替代
...
def eva02_tiny_patch14_xattn_fusedLN_SwiGLU_preln_RoPE(pretrained=False, **kwargs):
    # 移除timm新版本传入的多余参数
    for k in ['pretrained_cfg', 'pretrained_cfg_overlay', 'cache_dir', 'hf_hub_id', 'features_only', 'out_indices']:
        kwargs.pop(k, None)
